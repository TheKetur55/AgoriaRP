...
Citizen.CreateThread( function()
    while true do 
        ...
        if ped and inVehicle then
            if IsControlJustPressed(1, 73) and not IsPedInAnyHeli(ped) and not IsPedInAnyPlane(ped) then
            ...
            elseif IsControlJustPressed(1, 27) and not IsPedInAnyHeli(ped) and not IsPedInAnyPlane(ped) then
            ...
            elseif IsControlJustPressed(1, 173) and not IsPedInAnyHeli(ped) and not IsPedInAnyPlane(ped) then
                if CruiseControl == 1 then

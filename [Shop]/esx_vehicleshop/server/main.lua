...
MySQL.ready(function()
	...
	local vehicles = MySQL.Sync.fetchAll('SELECT * FROM vehicles ORDER BY price')
...
AddEventHandler('esx_vehicleshop:sellVehicle', function (playerId, vehicle, vehicleProps)
...
ESX.RegisterServerCallback('esx_vehicleshop:retrieveJobVehicles3', function (source, cb, type)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_vehicleshop:retrieveJobVehicles2', function (source, cb, type)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_vehicleshop:retrieveJobVehicles4', function (source, cb, type)
	local xPlayer = ESX.GetPlayerFromId(source)

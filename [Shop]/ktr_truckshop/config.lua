...
Config.Zones = {
	...
	ShopEntering = {
		Pos   = { x = 968.42, y = -3007.45, z = -39.64 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = 39
	},

	ShopInside = {
		Pos     = { x = 978.24, y = -3002.18, z = -39.50 },
		Size    = { x = 1.5, y = 1.5, z = 1.0 },
		Heading = -20.0,
		Type    = -1
	},
	...
	ShopOutside = {
		Pos     = { x = -157.76, y = -1162.33, z = 24.00 },
		Size    = { x = 1.5, y = 1.5, z = 1.0 },
		Heading = 330.0,
		Type    = -1
	},
	...
	GiveBackVehicle = {
		Pos   = { x = -157.76, y = -1162.33, z = 23.00 },
		Size  = { x = 3.0, y = 3.0, z = 1.0 },
		Type  = (Config.EnablePlayerManagement and 1 or -1)
	},

	ResellVehicle = {
		Pos   = { x = -157.39, y = -1178.42, z = 24.90 },
		Size  = { x = 3.0, y = 3.0, z = 1.0 },
		Type  = 1
	}

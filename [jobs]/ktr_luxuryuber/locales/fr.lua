Locales['fr'] = {
  ...
  ['only_event'] = 'vous ne pouvez ranger que les event',
  ['must_in_event'] = 'vous devez être dans un event pour commencer la mission',
  ...
  ['event_client'] = 'client event',
  ['have_withdrawn'] = 'Vous avez retiré x',
  ['added'] = 'Vous avez ajouté x',
  ['take_car'] = '~y~Votre véhicule se trouve à l\'extérieur',
}

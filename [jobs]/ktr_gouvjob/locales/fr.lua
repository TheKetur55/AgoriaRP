Locales['fr'] = {
  ...
  ['armory'] = 'armurerie',
   ['armory2'] = 'Objet confisqué',
  ['open_armory'] = 'appuyez sur ~INPUT_CONTEXT~ pour accéder à l\'armurerie',
    ['open_armory2'] = 'appuyez sur ~INPUT_CONTEXT~ pour accéder au objet confisqué',
  ['armory_owned'] = 'owned',
  ['armory_free'] = 'free',
  ['armory_item'] = '$%s',
  ...
  ['license_check'] = 'Supprimer une licences',
  ...
  ['confiscate_weapon'] = 'Vous avez confisquer %s avec %s munition',
  ['confiscate_inv'] = 'Vous avez confisquer %s X%s',

    ...
    while messagenotfinish do
      ...
      DisplayOnscreenKeyboard(1, "FMMC_MPM_NA", "", "", "", "", "", 100)
        ...
        if (GetOnscreenKeyboardResult()) then
           ...
           TriggerServerEvent('ktr_nightclub:annonce',result)
...
function OpenCloakroomMenu()
  ...
  local elements = {
    ...
    { label = ('Tenu Barman'),    value = 'barman_tenu'},
    { label = ('Tenu Vigil'),  value = 'vigil_tenu'},
    { label = ('Tenu Danse 1'),  value = 'danse1_tenu'},
    { label = ('Tenu Danse 2'),  value = 'danse2_tenu'},
    { label = ('Tenu Danse Police'),  value = 'flic_tenu'},
  ...
  if Config.EnableVaultManagement then
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value == 'get_weapon' and PasTig() then
          OpenGetWeaponMenu()
        end

        if data.current.value == 'put_weapon' and PasTig() then
          OpenPutWeaponMenu()
        end
        ...
        if data.current.value == 'get_stock' and PasTig() then
           OpenGetStocksMenu()
        end
...
function OpenFridgeMenu()
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value == 'put_stock' and PasTig() then
      ...
      if data.current.value == 'menu_crafting' then
          ...
          ESX.UI.Menu.Open(
              ...
              function(data2, menu2)
                ...
                TriggerServerEvent('ktr_nightclub:craftingCoktails', data2.current.value)
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('ktr_nightclub:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('ktr_nightclub:getStockItem', itemName, count)
            end
...
ESX.TriggerServerCallback('ktr_nightclub:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('ktr_nightclub:putStockItems', itemName, count)
            end
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('ktr_nightclub:getFridgeStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('ktr_nightclub:getFridgeStockItem', itemName, count)
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('ktr_nightclub:putFridgeStockItems', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('ktr_nightclub:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('ktr_nightclub:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('ktr_nightclub:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open(
        ...
        function(data, menu)
            TriggerServerEvent('ktr_nightclub:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end,
        function(data, menu)
            menu.close()
        end
...
AddEventHandler('ktr_nightclub:hasEnteredMarker', function(zone)
...
AddEventHandler('ktr_nightclub:hasExitedMarker', function(zone)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('ktr_nightclub:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('ktr_nightclub:hasExitedMarker', LastZone)
            end
        ...
        while true do
            Citizen.Wait(1)    
                ...
                if (affichenews == true) then
                    ...
                    DrawAdvancedTextCNN(0.588, 0.02, 0.005, 0.0028, 0.8, "~r~ El Venetie'S Club ~d~", 255, 255, 255, 255, 1, 0)
...
RegisterNetEvent('ktr_nightclub:annonce')
AddEventHandler('ktr_nightclub:annonce', function(text)
    texteafiche = text
    affichenews = true
...
RegisterNetEvent('ktr_nightclub:annoncestop')
AddEventHandler('ktr_nightclub:annoncestop', function()
    affichenews = false

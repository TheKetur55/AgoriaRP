...
RegisterServerEvent('ktr_nightclub:getStockItem')
AddEventHandler('ktr_nightclub:getStockItem', function(itemName, count)
...
ESX.RegisterServerCallback('ktr_nightclub:getStockItems', function(source, cb)
...
RegisterServerEvent('ktr_nightclub:putStockItems')
AddEventHandler('ktr_nightclub:putStockItems', function(itemName, count)
...
RegisterServerEvent('ktr_nightclub:getFridgeStockItem')
AddEventHandler('ktr_nightclub:getFridgeStockItem', function(itemName, count)
...
ESX.RegisterServerCallback('ktr_nightclub:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('ktr_nightclub:putFridgeStockItems')
AddEventHandler('ktr_nightclub:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('ktr_nightclub:buyItem')
AddEventHandler('ktr_nightclub:buyItem', function(itemName, price, itemLabel)
...
RegisterServerEvent('ktr_nightclub:craftingCoktails')
AddEventHandler('ktr_nightclub:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('ktr_nightclub:getVaultWeapons', function(source, cb)
...
ESX.RegisterServerCallback('ktr_nightclub:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('ktr_nightclub:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('ktr_nightclub:getPlayerInventory', function(source, cb)
...
RegisterServerEvent('ktr_nightclub:annonce')
AddEventHandler('ktr_nightclub:annonce', function(result)
  local _source  = source
  local xPlayer  = ESX.GetPlayerFromId(_source)
  ...
  for i=1, #xPlayers, 1 do
    ...
    TriggerClientEvent('ktr_nightclub:annonce', xPlayers[i],text)
  end
  ...
  for i=1, #xPlayers, 1 do
    local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
    TriggerClientEvent('ktr_nightclub:annoncestop', xPlayers[i])
  end

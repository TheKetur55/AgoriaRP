...
--	end
	...
	if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.grade_name == 'boss' and PlayerData.job.grade_name == 'chief_doctor' and PlayerData.job.grade_name == 'doctor' then -- Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.grade_name == 'boss'
	...
	ESX.UI.Menu.Open(
		...
		function(data, menu)
			...
			CurrentAction     = 'vigne_actions_menu2'
			CurrentActionMsg  = _U('press_to_open')
			CurrentActionData = {}
...
AddEventHandler('esx_vigneronjob:hasEnteredMarker', function(zone)
	...
	if  zone == 'RaisinFarm3'  and PlayerData.job ~= nil and PlayerData.job.name == 'vigne'  then
		CurrentAction     = 'raisin_harvest'
		CurrentActionMsg  = _U('press_collect')
		CurrentActionData = {zone= zone}
	end
	...
	if zone == 'SellFarm3' and PlayerData.job ~= nil and PlayerData.job.name == 'vigne'  then
		CurrentAction     = 'farm_resell'
		CurrentActionMsg  = _U('press_sell')
		CurrentActionData = {zone = zone}
	end
	...
	if zone == 'VigneronActions2' and PlayerData.job ~= nil and PlayerData.job.name == 'vigne' then
		CurrentAction     = 'vigne_actions_menu2'
		CurrentActionMsg  = _U('press_to_open')
		CurrentActionData = {}
	end
	...
	while true do
		...
		if CurrentAction ~= nil then
			...
			if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'vigne' and (GetGameTimer() - GUI.Time) > 300 then
				...
				if CurrentAction == 'vigne_actions_menu2' then

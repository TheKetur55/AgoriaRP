    ...
    while true do
        ...
        for locationIndex = 1, #Config.SellBottleLocations do
          ...
          if dstCheck <= 2.0 then
                ...
                local text = "Acheteur d'orange"

                if dstCheck <= 0.5 then
                    text = "[~g~E~s~] " .. text

                    if IsControlJustReleased(0, 38) then
                        TriggerServerEvent("ktr_orangejob:sellBottles")
                    end
                end
    ...
    while true do
        ...
        for locationIndex2 = 1, #Config.BinsAvailable do
            ...
            if dstCheck <= 5.0 then
                ...
                ESX.Game.Utils.DrawText3D(locationPos2, text, 0.4)
            end
        end
...
function OpenTrashCan()
    ...
    TriggerServerEvent("ktr_orangejob:retrieveBottle")
    Citizen.Wait(3000)
    TriggerServerEvent("ktr_orangejob:retrieveBottle")
    Citizen.Wait(3000)
    TriggerServerEvent("ktr_orangejob:retrieveBottle")

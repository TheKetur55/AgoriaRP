...
function PasTig()
    if PlayerData ~= nil then
      --  local IsGradeBoss = false
        if PlayerData.job.grade_name == 'boss' or PlayerData.job.grade_name == 'recrue' or PlayerData.job.grade_name == 'novice' or PlayerData.job.grade_name == 'cdisenior'   then
        --    IsGradeBoss = true
        end
       return IsGradeBoss
    end
...
function StoreNearbyVehicle(playerCoords)
	...
	ESX.TriggerServerCallback('esx_vigneronjob2:storeNearbyVehicle', function(storeSuccess, foundNum)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop', {
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop_confirm',
		{
			...
			if data2.current.value == 'yes' then
				...
				ESX.TriggerServerCallback('esx_vigneronjob2:buyJobVehicle', function (bought)
					if bought then
...
AddEventHandler('esx_phone:cancelMessage', function(dispatchNumber)
	if type(PlayerData.job.name) == 'string' and PlayerData.job.name == 'vigne' and PlayerData.job.name == dispatchNumber then
...
AddEventHandler('esx_vigneronjob2:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('esx_vigneronjob2:hasExitedMarker', function(station, part, partNum)
...
AddEventHandler('esx_vigneronjob2:hasEnteredEntityZone', function(entity)
	local playerPed = PlayerPedId()

	if PlayerData.job ~= nil and PlayerData.job.name == 'vigne' and IsPedOnFoot(playerPed) then
...
AddEventHandler('esx_vigneronjob2:hasExitedEntityZone', function(entity)
	...
	while true do
		...
		if PlayerData.job ~= nil and PlayerData.job.name == 'vigne' then
			...
			if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum)) then
				...
				then
					TriggerEvent('esx_vigneronjob2:hasExitedMarker', LastStation, LastPart, LastPartNum)
					hasExited = true
				end
				...
				TriggerEvent('esx_vigneronjob2:hasEnteredMarker', currentStation, currentPart, currentPartNum)
...
function OpenGetStocksMenu()
	...
	ESX.TriggerServerCallback('esx_vigneronjob2:getStockItems', function(items)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu',
		{
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
				...
				if count == nil then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('esx_vigneronjob2:getStockItem', itemName, count)
...
function OpenPutStocksMenu()
	...
	ESX.TriggerServerCallback('esx_vigneronjob2:getPlayerInventory', function(inventory)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu',
		{
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
				...
				if count == nil then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('esx_vigneronjob2:putStockItems', itemName, count)
...
Citizen.CreateThread(function()
	while true do
		...
		if CurrentAction ~= nil then
			...
			if IsControlJustReleased(0, Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'vigne' then

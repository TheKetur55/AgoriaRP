...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'tonys', Config.MaxInService)
end

--TriggerEvent('esx_phone:registerNumber', 'tonys', _U('tonys_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'tonys', 'tonys', 'society_tonys', 'society_tonys', 'society_tonys', {type = 'private'})



RegisterServerEvent('esx_tonysjob:getStockItem')
AddEventHandler('esx_tonysjob:getStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_tonys', function(inventory)
...
ESX.RegisterServerCallback('esx_tonysjob:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_tonysjob:putStockItems')
AddEventHandler('esx_tonysjob:putStockItems', function(itemName, count)
...
RegisterServerEvent('esx_tonysjob:getFridgeStockItem')
AddEventHandler('esx_tonysjob:getFridgeStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_tonys_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_tonysjob:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('esx_tonysjob:putFridgeStockItems')
AddEventHandler('esx_tonysjob:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_tonysjob:buyItem')
AddEventHandler('esx_tonysjob:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', 'society_tonys', function(account)
...
RegisterServerEvent('esx_tonysjob:craftingCoktails')
AddEventHandler('esx_tonysjob:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_tonysjob:getVaultWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_tonys', function(store)
...
ESX.RegisterServerCallback('esx_tonysjob:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_tonysjob:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_tonysjob:getPlayerInventory', function(source, cb)

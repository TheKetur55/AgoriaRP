...
function OpenVehicleSpawnerMenu(type, station, part, partNum)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle', {
		...
		if data.current.action == 'buy_vehicle' then
			...
			if type == 'car' then
				shopCoords = Config.tabacStations[station].Vehicles[partNum].InsideShop
			...
			elseif type == 'helicopter' then
				shopCoords = Config.tabacStations[station].Helicopters[partNum].InsideShop
...
function StoreNearbyVehicle(playerCoords)
	...
	ESX.TriggerServerCallback('ktr_tabacjob:storeNearbyVehicle', function(storeSuccess, foundNum)
...
function GetAvailableVehicleSpawnPoint(station, part, partNum)
	local spawnPoints = Config.tabacStations[station][part][partNum].SpawnPoints
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop', {
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop_confirm',
		{
			...
			if data2.current.value == 'yes' then
				...
				ESX.TriggerServerCallback('ktr_tabacjob:buyJobVehicle', function (bought)
					if bought then
...
AddEventHandler('esx_phone:cancelMessage', function(dispatchNumber)
	if type(PlayerData.job.name) == 'string' and PlayerData.job.name == 'tabac' and PlayerData.job.name == dispatchNumber then
...
AddEventHandler('ktr_tabacjob:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('ktr_tabacjob:hasExitedMarker', function(station, part, partNum)
...
AddEventHandler('ktr_tabacjob:hasEnteredEntityZone', function(entity)
	local playerPed = PlayerPedId()

	if PlayerData.job ~= nil and PlayerData.job.name == 'tabac' and IsPedOnFoot(playerPed) then
...
AddEventHandler('ktr_tabacjob:hasExitedEntityZone', function(entity)
...
Citizen.CreateThread(function()
	while true do
		...
		if PlayerData.job ~= nil and PlayerData.job.name == 'tabac' then
			...
			for k,v in pairs(Config.tabacStations) do
			...
			if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum)) then
				...
				then
					TriggerEvent('ktr_tabacjob:hasExitedMarker', LastStation, LastPart, LastPartNum)
					hasExited = true
				end
				...
				TriggerEvent('ktr_tabacjob:hasEnteredMarker', currentStation, currentPart, currentPartNum)
...
function OpenGetStocksMenu()
	...
	ESX.TriggerServerCallback('ktr_tabacjob:getStockItems', function(items)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu',
		{
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
				...
				if count == nil then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('ktr_tabacjob:getStockItem', itemName, count)
...
function OpenPutStocksMenu()
	...
	ESX.TriggerServerCallback('ktr_tabacjob:getPlayerInventory', function(inventory)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu',
		{
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
				...
				if count == nil then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('ktr_tabacjob:putStockItems', itemName, count)
...
Citizen.CreateThread(function()
	while true do
		...
		if CurrentAction ~= nil then
			...
			if IsControlJustReleased(0, Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'tabac' then
...
function OpeneventActionsMenu(target)
          ...
          function(data, menu)
            ...
            if amount == nil or amount < 0 then
              ...
              if closestPlayer == -1 or closestDistance > 3.0 then
                ...
                TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_tabac', ('Agoria Tabac'), amount)
           --  end)
							end
						end
					end,
	...
	--	if IsControlJustReleased(0, Keys['F6']) and not isDead and PlayerData.job ~= nil and PlayerData.job.name == 'tabac' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'tabac_actions') then
	...
	--		end
		...
		if IsControlJustReleased(0, Keys['F6']) and not isDead and PlayerData.job ~= nil and PlayerData.job.name == 'tabac' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'event_actions') then
...
function Message()
    ...
    while messagenotfinish do
		    ...
		    if (GetOnscreenKeyboardResult()) then
		       ...
		       TriggerServerEvent('ktr_eventjob:annonce',result)
		    ...
		    while true do
		        Citizen.Wait(1)    
		            ...
		            if (affichenews == true) then
				            ...
				            DrawAdvancedTextCNN(0.588, 0.02, 0.005, 0.0028, 0.8, "~r~ Tabac ~d~", 255, 255, 255, 255, 1, 0)
...
RegisterNetEvent('ktr_tabacjob:annonce')
AddEventHandler('ktr_tabacjob:annonce', function(text)
 		texteafiche = text
 		affichenews = true
...
RegisterNetEvent('ktr_tabacjob:annoncestop')
AddEventHandler('ktr_tabacjob:annoncestop', function()
 		affichenews = false

...
TriggerEvent('esx_joblogs:AddInLog',"lspdarmor" ,"lspd_armurier_buy" ,xPlayer.name, weaponName)
	...
	if not selectedWeapon then
		...
		if type == 1 then
			...
			--	TriggerEvent('esx_joblogs:AddInLog',"police" ,"lspd_armurier_buy" ,xPlayer.name, weaponName)
				cb(true)
			else
				cb(false)
			end
...
ESX.RegisterServerCallback('esx_policejob:getArmoryWeapons2', function(source, cb)
	TriggerEvent('esx_datastore:getSharedDataStore', 'society_police2', function(store)
		local weapons = store.get('weapons')
...
ESX.RegisterServerCallback('esx_policejob:addArmoryWeapon2', function(source, cb, weaponName, removeWeapon)
	local xPlayer = ESX.GetPlayerFromId(source)
...
ESX.RegisterServerCallback('esx_policejob:removeArmoryWeapon2', function(source, cb, weaponName)
	local xPlayer = ESX.GetPlayerFromId(source)
	xPlayer.addWeapon(weaponName, 500)

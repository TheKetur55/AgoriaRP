...
local pizzeria = { x = -1187.47, y = -1732.87, z = 3.46} --Configuration marker prise de service
  ...
  while true do
    ...
    if isToHouse == true then
      ...
      while notif == true do
        ...
        ESX.ShowNotification('Livrer la pizza')
    ...
    if isToPizzaria == true then
      ...
      while notif2 == true do
        ...
        ESX.ShowNotification('Direction la pizzeria')

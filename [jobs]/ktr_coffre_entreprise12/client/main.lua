...
AddEventHandler('ktr_coffre_entreprise12:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('ktr_coffre_entreprise12:hasExitedMarker', function(station, part, partNum)
...
AddEventHandler('ktr_coffre_entreprise12:hasEnteredEntityZone', function(entity)
...
AddEventHandler('ktr_coffre_entreprise12:hasExitedEntityZone', function(entity)
	...
	while true do
		...
		if PlayerData.job ~= nil and PlayerData.job.name == 'shop' then
			...
			if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum)) then
				...
				then
					TriggerEvent('ktr_coffre_entreprise12:hasExitedMarker', LastStation, LastPart, LastPartNum)
					hasExited = true
				end
				...
				TriggerEvent('ktr_coffre_entreprise12:hasEnteredMarker', currentStation, currentPart, currentPartNum)
...
function OpenGetStocksMenu()
	...
	ESX.TriggerServerCallback('ktr_coffre_entreprise12:getStockItems', function(items)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu',
		{
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
				...
				if count == nil then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('ktr_coffre_entreprise12:getStockItem', itemName, count)
...
function OpenPutStocksMenu()
	...
	ESX.TriggerServerCallback('ktr_coffre_entreprise12:getPlayerInventory', function(inventory)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu',
		{
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
				...
				if count == nil then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('ktr_coffre_entreprise12:putStockItems', itemName, count)

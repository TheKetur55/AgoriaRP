...
function OpenCloakroomMenu()
	...
	elseif grade == 'sergeant2' then
		table.insert(elements, {label = _U('securitas_wear'), value = 'sergeant2_wear'})
    ...
    --    TriggerServerEvent("player:serviceOff", "securitas")
    ...
    ---- --   TriggerServerEvent("player:serviceOn", "securitas")
    --    ESX.ShowNotification('Prise de ~g~Service')
		end
...
function StoreNearbyVehicle(playerCoords)
	...
	ESX.TriggerServerCallback('ktr_securitasjob:storeNearbyVehicle', function(storeSuccess, foundNum)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop', {
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop_confirm',
		{
			...
			if data2.current.value == 'yes' then
				...
				ESX.TriggerServerCallback('ktr_securitasjob:buyJobVehicle', function (bought)
					if bought then
...
AddEventHandler('ktr_securitasjob:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('ktr_securitasjob:hasExitedMarker', function(station, part, partNum)
...
AddEventHandler('ktr_securitasjob:hasEnteredEntityZone', function(entity)
	local playerPed = PlayerPedId()
...
AddEventHandler('ktr_securitasjob:hasExitedEntityZone', function(entity)
	...
	while true do
		...
		if PlayerData.job ~= nil and PlayerData.job.name == 'securitas' then
			...
			if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum)) then
				...
				then
					TriggerEvent('ktr_securitasjob:hasExitedMarker', LastStation, LastPart, LastPartNum)
					hasExited = true
				end
				...
				TriggerEvent('ktr_securitasjob:hasEnteredMarker', currentStation, currentPart, currentPartNum)
...
function OpenGetStocksMenu()
	...
	ESX.TriggerServerCallback('ktr_securitasjob:getStockItems', function(items)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu',
		{
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
				...
				if count == nil then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('ktr_securitasjob:getStockItem', itemName, count)
...
function OpenPutStocksMenu()
	...
	ESX.TriggerServerCallback('ktr_securitasjob:getPlayerInventory', function(inventory)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu',
		{
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
				...
				if count == nil then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('ktr_securitasjob:putStockItems', itemName, count)

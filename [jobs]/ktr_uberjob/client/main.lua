...
function StarteventJob()

  ShowLoadingPromt(_U('taking_service') .. 'event/Uber', 5000, 3)
  ClearCurrentMission()
 ...
 --   {label = _U('take_stock'), value = 'get_stock'}
  ...
  ESX.UI.Menu.Open(
      ...
      if data.current.value == 'spawn_vehicle' then
        ...
        if Config.EnableSocietyOwnedVehicles then
            ...
            ESX.UI.Menu.Open(
              ...
              function(data, menu)
                ...
                ESX.Game.SpawnVehicle(vehicleProps.model, Config.Zones.VehicleSpawnPoint.Pos, 270.0, function(vehicle)
                  ...
                  ESX.ShowNotification(_U('take_car'))
                end)
                
                TriggerServerEvent('esx_society:removeVehicleFromGarage', 'event', vehicleProps)
          ...
          if Config.MaxInService == -1 then
            ...
            ESX.Game.SpawnVehicle('baller3', coords, 225.0, function(vehicle)
              TaskWarpPedIntoVehicle(playerPed,  vehicle, -1)
            end)
    ...
    function(data, menu)
      ...
      CurrentAction     = 'event_actions_menu'
...
function OpenMobileeventActionsMenu()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'mobile_event_actions',
    {
      title    = 'Luxury Uber',
      elements = {
          ...
          function(data, menu)
            ...
            if amount == nil then
              ...
              if closestPlayer == -1 or closestDistance > 3.0 then
                ...
                TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_event', 'Luxury Uber', amount)
              end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('ktr_uberjob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('ktr_uberjob:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
  ...
  ESX.TriggerServerCallback('ktr_uberjob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('ktr_uberjob:putStockItems', itemName, count)
            end
...
AddEventHandler('ktr_uberjob:hasEnteredMarker', function(zone)

  if zone == 'eventActions' then
    CurrentAction     = 'event_actions_menu'
    CurrentActionMsg  = _U('press_to_open')
    CurrentActionData = {}
  end
...
AddEventHandler('ktr_uberjob:hasExitedMarker', function(zone)
  ESX.UI.Menu.CloseAll()
  CurrentAction = nil
end)
...
Citizen.CreateThread(function()
  ...
  local blip = AddBlipForCoord(Config.Zones.eventActions.Pos.x, Config.Zones.eventActions.Pos.y, Config.Zones.eventActions.Pos.z)
  ...
  AddTextComponentString("Dépôt event")
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'event' then
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'event' then
      ...
      if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
        ...
        TriggerEvent('ktr_uberjob:hasEnteredMarker', currentZone)
      end

      if not isInMarker and HasAlreadyEnteredMarker then
        HasAlreadyEnteredMarker = false
        TriggerEvent('ktr_uberjob:hasExitedMarker', LastZone)
      end
          ...
          if IsPedSittingInVehicle(CurrentCustomer,  vehicle) then
            ...
            if CustomerEnteredVehicle then
              ...
              if targetDistance <= 10.0 then
                ...
                TriggerServerEvent('ktr_uberjob:success')
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'event' and (GetGameTimer() - GUI.Time) > 300 and GetLastInputMethod(2) then

        if CurrentAction == 'event_actions_menu' then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'event', vehicleProps)
          else
            if GetEntityModel(CurrentActionData.vehicle) == GetHashKey('event') then
              if Config.MaxInService ~= -1 then
...
function OpeneventActionsMenu2(target)
          ...
          function(data, menu)
            ...
            if amount == nil or amount < 0 then
              ...
              if closestPlayer == -1 or closestDistance > 3.0 then
                ...
                TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_event', ('Luxurt Uber'), amount)
           --  end)
							end
						end
					end,
    ...
    if IsControlPressed(0,  Keys['F2']) and (GetGameTimer() - GUI.Time) > 150 and GetLastInputMethod(2) then
        ...
        if PlayerData.job ~= nil and PlayerData.job.name == 'event' then
          ...
          if IsPedInAnyVehicle(playerPed,  false) then
            ...
            if PlayerData.job.grade >= 0 then
              ...
              if GetEntityModel(vehicle) == GetHashKey('baller3') then
                StarteventJob()
              else
                ESX.ShowNotification(_U('must_in_event'))
              end
            end
		    ...
		    while true do
		        Citizen.Wait(1)    
		            ...
		            if (affichenews == true) then
				            ...
				            DrawAdvancedTextCNN(0.588, 0.02, 0.005, 0.0028, 0.8, "~r~ Luxury Uber ~d~", 255, 255, 255, 255, 1, 0)
...
RegisterNetEvent('ktr_uberjob:annonce')
AddEventHandler('ktr_uberjob:annonce', function(text)
 		texteafiche = text
 		affichenews = true
...
RegisterNetEvent('ktr_uberjob:annoncestop')
AddEventHandler('ktr_uberjob:annoncestop', function()
 		affichenews = false

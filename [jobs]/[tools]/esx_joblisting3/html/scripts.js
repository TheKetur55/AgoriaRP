...
$(document).ready(function(){
  ...
  function postApplication() {
	...
	$.post('http://esx_joblisting3/postApplication', JSON.stringify({phone : _phone, licenses : _licenses, exp : _exp, type : _type}));
	emptyEditor();
	$.post('http://esx_joblisting3/closeMenu', JSON.stringify({}));

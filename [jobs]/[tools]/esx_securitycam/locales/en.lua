Locales['en'] = {
  ...
  -- Menu
  ['securitycams_menu'] = 'Camera | Agoria Paradise',
  ['bank_menu_selection'] = 'Banque Central',
  ['police_menu_selection'] = 'Commissariat',
   ['agoria_menu_selection'] = 'Place Central | Agoria',

  -- In Cameras
  ['pacific_standard_bank'] = 'Banque Central',
  ['police_station'] = 'Commissariat',
['agoria_place'] = 'Place Central | Agoria',
  ...
  ['nothing_wrong'] = 'Il vous manque quelque chose',
  ['removing_viruses'] = 'Vous retirer le virus...',

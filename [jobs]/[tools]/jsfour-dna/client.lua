...
local dna 				= {}
local weapons = {
	[-1569615261] = {name = 'WEAPON_UNARMED', hash = 2725352035, text = 'Main nu'},
	[-1716189206] = {name = 'WEAPON_KNIFE', hash = 2578778090, text = 'Couteau'},
	[1737195953]  = {name = 'WEAPON_NIGHTSTICK', hash = 1737195953, text = 'Matraque'},
	[2508868239]  = {name = 'WEAPON_BAT', hash = 2508868239, text = 'Batte'},
	[1317494643]  = {name = 'WEAPON_HAMMER', hash = 1317494643, text = 'Marteau'},
	[1141786504]  = {name = 'WEAPON_GOLFCLUB', hash =1141786504, text = 'Club de golf'},
	[2227010557]  = {name = 'WEAPON_CROWBAR', hash =2227010557, text = 'Pied de biche'},
	[2460120199]  = {name = 'WEAPON_DAGGER', hash =2460120199, text = 'Poignard'},
	[3638508604]  = {name = 'WEAPON_KNUCKLE', hash =3638508604, text = 'Poing américain'},
	[4191993645]  = {name = 'WEAPON_HATCHET', hash =4191993645, text = 'Hachette'},
	[3713923289]  = {name = 'WEAPON_MACHETE', hash =3713923289, text = 'Machette'},
	[3756226112]  = {name = 'WEAPON_SWITCHBLADE', hash =3756226112, text = 'Couteau à cran d\'arrêt'},
	[3441901897]  = {name = 'WEAPON_BATTLEAXE', hash =3441901897, text = 'Hache de combat'},
	[2484171525]  = {name = 'WEAPON_POOLCUE', hash =2484171525, text = 'Queue de billard'},
	[419712736]   = {name = 'WEAPON_WRENCH', hash =419712736, text = 'Clé'}
}
	...
	if dna.p == nil then
		...
		if IsPedFatallyInjured(ped) then
			...
			if weapon ~= nil then
				...
				ESX.ShowNotification('Saisir l\'ADN du cadavre..')
			else
				ESX.ShowNotification("Impossible de trouver de l'ADN..")
			end
		else
			dna = {k = nil, d = nil, w = nil, p = GetPlayerServerId(player)}
			ESX.ShowNotification('Saisir l\'ADN de la personne..')
		end
	else
		ESX.ShowNotification('Vous avez déjà un échantillon d\'ADN sur vous, merci de le télécharger..')
	end
end)

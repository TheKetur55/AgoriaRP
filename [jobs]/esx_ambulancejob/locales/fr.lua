Locales['fr'] = {
  ...
  ['actions_prompt'] = 'appuyez sur ~INPUT_CONTEXT~ pour acceder au~y~Vestiaire~s~.',
  ...
  ['distress_send'] = 'appuyez sur [~b~G~s~] pour envoyer un message au LSMD',
...
['has_ambulance']       = '~r~Vous ne pouvez utiliser ce kit, un ambulancier est en service',
  ...
  ['must_in_vehicle'] = 'vous devez être dans un véhicule',

...
function OpenMobileAmbulanceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mobile_ambulance_actions', {
		...
		elements = {
			...
			{label = ('Montrer sa carte LSMD'),	value = 'menuperso_moi_idcard_show'}
		}
	}, function(data, menu)
...
if  data.current.value == 'menuperso_moi_idcard_show' then
        TriggerEvent('esx_cards:show', 'job')
end
						...
						ESX.TriggerServerCallback('esx_ambulancejob:getItemAmount', function(quantity)
							if quantity > 0 then
								...
								if IsPedDeadOrDying(closestPlayerPed, 1) then
									...
									for i=1, 15, 1 do
										exports['progressBars']:startUI(900, "Réanimation en cours...")
										Citizen.Wait(900)
						...
						ESX.TriggerServerCallback('esx_ambulancejob:getItemAmount', function(quantity)
							if quantity > 0 then
								...
								if health > 0 then
									...
									exports['progressBars']:startUI(8000, "Soin en cours...")
									Citizen.Wait(8000)
						...
						ESX.TriggerServerCallback('esx_ambulancejob:getItemAmount', function(quantity)
							if quantity > 0 then
								...
								if health > 0 then
									...
									ESX.ShowNotification(_U('heal_inprogress'))
									TaskStartScenarioInPlace(playerPed, 'CODE_HUMAN_MEDIC_TEND_TO_DEAD', 0, true)
									exports['progressBars']:startUI(13000, "Soin en cours...")
									Citizen.Wait(13000)
									ClearPedTasks(playerPed)
...
Citizen.CreateThread(function()
	while true do
      ...
      ESX.ShowNotification('Vous n\'etes pas en ~r~service')
			...
			--	else
     -- ESX.ShowNotification('Vous devez être ~b~en service~s~ pour accéder aux intéractions.')
		    ...
		    while true do
		        Citizen.Wait(1)    
		            ...
		            if (affichenews == true) then
				            ...
				            DrawAdvancedTextCNN(0.588, 0.02, 0.005, 0.0028, 0.8, "~r~ Los Santos Medical Département ~d~", 255, 255, 255, 255, 1, 0)

...
local pizzeria = { x = -1187.47, y = -1732.87, z = 3.46} --Commencer
local pizzeriafin = { x = -1177.04, y = -1746.40, z = 3.00} --Fın
local spawnfaggio = { x = -1185.92, y = -1747.93, z = 3.00} --Spawn véhicule

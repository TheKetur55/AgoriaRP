...
AddEventHandler('esx_realestateagentjob:hasEnteredMarker', function(zone)
	...
	if zone == 'OfficeActions' and ESX.PlayerData.job ~= nil and ESX.PlayerData.job.name == 'realestateagent' then
		CurrentAction     = 'realestateagent_menu'
		CurrentActionMsg  = _U('press_to_access')
		CurrentActionData = {}
	end
		    ...
		    while true do
		        Citizen.Wait(1)    
		            ...
		            if (affichenews == true) then
				            ...
				            DrawAdvancedTextCNN(0.588, 0.02, 0.005, 0.0028, 0.8, "~r~ AGORIA IMMOBILIER ~d~", 255, 255, 255, 255, 1, 0)

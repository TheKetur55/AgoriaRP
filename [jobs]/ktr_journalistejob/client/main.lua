...
function OpenVehicleSpawnerMenu(type, station, part, partNum)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle', {
		...
		if data.current.action == 'buy_vehicle' then
			...
			if type == 'car' then
				shopCoords = Config.journalisteStations[station].Vehicles[partNum].InsideShop
			...
			elseif type == 'helicopter' then
				shopCoords = Config.journalisteStations[station].Helicopters[partNum].InsideShop
...
function StoreNearbyVehicle(playerCoords)
	...
	ESX.TriggerServerCallback('ktr_journalistejob:storeNearbyVehicle', function(storeSuccess, foundNum)
...
function GetAvailableVehicleSpawnPoint(station, part, partNum)
	local spawnPoints = Config.journalisteStations[station][part][partNum].SpawnPoints
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop', {
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop_confirm',
		{
			...
			if data2.current.value == 'yes' then
				...
				ESX.TriggerServerCallback('ktr_journalistejob:buyJobVehicle', function (bought)
					if bought then
...
AddEventHandler('esx_phone:cancelMessage', function(dispatchNumber)
	if type(PlayerData.job.name) == 'string' and PlayerData.job.name == 'journaliste' and PlayerData.job.name == dispatchNumber then
...
AddEventHandler('ktr_journalistejob:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('ktr_journalistejob:hasExitedMarker', function(station, part, partNum)
...
AddEventHandler('ktr_journalistejob:hasEnteredEntityZone', function(entity)
	local playerPed = PlayerPedId()

	if PlayerData.job ~= nil and PlayerData.job.name == 'journaliste' and IsPedOnFoot(playerPed) then
...
AddEventHandler('ktr_journalistejob:hasExitedEntityZone', function(entity)
...
Citizen.CreateThread(function()
	while true do
		...
		if PlayerData.job ~= nil and PlayerData.job.name == 'journaliste' then
			...
			for k,v in pairs(Config.journalisteStations) do
			...
			if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum)) then
				...
				then
					TriggerEvent('ktr_journalistejob:hasExitedMarker', LastStation, LastPart, LastPartNum)
					hasExited = true
				end
				...
				TriggerEvent('ktr_journalistejob:hasEnteredMarker', currentStation, currentPart, currentPartNum)
...
function OpenGetStocksMenu()
	...
	ESX.TriggerServerCallback('ktr_journalistejob:getStockItems', function(items)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu',
		{
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
				...
				if count == nil then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('ktr_journalistejob:getStockItem', itemName, count)
...
function OpenPutStocksMenu()
	...
	ESX.TriggerServerCallback('ktr_journalistejob:getPlayerInventory', function(inventory)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu',
		{
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
				...
				if count == nil then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('ktr_journalistejob:putStockItems', itemName, count)
...
Citizen.CreateThread(function()
	while true do
		...
		if CurrentAction ~= nil then
			...
			if IsControlJustReleased(0, Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'journaliste' then
...
function OpeneventActionsMenu(target)
	...
	--table.insert(elements, {label = ('Caméra'), value = 'camera'})
	--table.insert(elements, {label = ('micro'), value = 'micro'})
--	table.insert(elements, {label = ('cpa'), value = 'cpa'})
 ...
 local src = source
    TriggerClientEvent("Cam:ToggleCam", src)
    		...
    		if data.current.value == 'micro' then	
   local src = source
    TriggerClientEvent("Mic:ToggleBMic", src)
end
    			if data.current.value == 'cpa' then	
    				   local src = source
          ...
          function(data, menu)
            ...
            if amount == nil or amount < 0 then
              ...
              if closestPlayer == -1 or closestDistance > 3.0 then
                ...
                TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_journaliste', ('Agoria Journalisme'), amount)
           --  end)
							end
						end
					end,
	...
	if IsControlJustReleased(0, Keys['F6']) and not isDead and PlayerData.job ~= nil and PlayerData.job.name == 'journaliste' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'event_actions') then

	...
	Citizen.CreateThread(function()
	  	while true do
		    ...
		    if  IsDisabledControlJustReleased(1, 38) and GetVehiclePedIsIn(player, false) == 0 and DoesEntityExist(vehicle) and IsEntityAVehicle(vehicle) then
		    	...
		    	elseif inside and IsDisabledControlJustReleased(1, 38) then

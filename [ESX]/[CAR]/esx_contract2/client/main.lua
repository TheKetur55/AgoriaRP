...
RegisterNetEvent('esx_contract2:getVehicle')
AddEventHandler('esx_contract2:getVehicle', function()
...
RegisterNetEvent('esx_contract2:showAnim')
AddEventHandler('esx_contract2:showAnim', function(player)

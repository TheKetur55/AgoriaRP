...
Config.Garages = {
	...
	--	Pos = {x=215.800, y=-810.057, z=30.727},
		...
		Functionmenu = OpenMenuGarage,
		SpawnPoint = {
			Pos = {x= 733.46, y= -2988.43, z= -39.99},
			Heading = 182.05,
			Marker = { w= 1.5, h= 1.5,r=0,g=255,b=0},
			HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour sortir votre du AgoTuning",
			Functionmenu = ListVehiclesMenu,
		},
		DeletePoint = {
			Pos = {x= 728.96, y= -2988.25, z= -39.99},
			Marker = { w= 1.5, h= 1.5,r=255,g=0,b=0},
			HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour ranger le véhicule dans le AgoTuning",
			Functionmenu = StockVehicleMenu,
		}, 	
	},
...
Garage_Agoria = {	
		...
		Functionmenu = OpenMenuGarage,
		SpawnPoint = {
			Pos = {x=-1170.96, y= -1773.17, z= 3.13},
			Heading = 303.98,
			Marker = { w= 1.5, h= 1.5,r=0,g=255,b=0},
			HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour sortir votre véhicule",
			Functionmenu = ListVehiclesMenu,
		...
		DeletePoint = {
			Pos = {x=-1172.98, y=-1769.97, z=3.13},
			Marker = { w= 1.5, h= 1.5,r=255,g=0,b=0},
			HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour rentrer votre véhicule",
			Functionmenu = StockVehicleMenu,
		}, 	
	...
	Garage_Centreg = {	
		Pos = {x = -281.34,y = -888.24,z = 31.31},
		Marker = { w= 1.5, h= 1.5,r = 204, g = 204, b = 0},
		Name = 'Garage',
		HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour ouvrir le garage",
		Functionmenu = OpenMenuGarage,
		SpawnPoint = {
			Pos = {x = -282.74,y = -893.10,z = 31.08},
			Heading = 79.20,
	...
	Garage_Paletof = {	
		Pos = {x=1726.72, y=3717.80, z=33.15},
		Marker = { w= 1.5, h= 1.5,r = 204, g = 204, b = 0},
		Name = 'Garage',
		HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour ouvrir le garage",
		Functionmenu = OpenMenuGarage,
		SpawnPoint = {
			Pos = {x=1723.30, y=3713.05, z=33.22},
			Heading = 160.0,
			Marker = { w= 1.5, h= 1.5,r=0,g=255,b=0},
			HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour sortir votre véhicule",
			Functionmenu = ListVehiclesMenu,
		...
		DeletePoint = {
			Pos = {x=1729.25, y=3711.90, z=33.22},
			Marker = { w= 1.5, h= 1.5,r=255,g=0,b=0},
			HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour rentrer votre véhicule",
			Functionmenu = StockVehicleMenu,
		}, 	
	...
	Garage_Paletoe = {	
		Pos = {x=1303.29, y=4320.73, z=37.19},
		Marker = { w= 1.5, h= 1.5,r = 204, g = 204, b = 0},
		Name = 'Garage',
		HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour ouvrir le garage",
		Functionmenu = OpenMenuGarage,
		SpawnPoint = {
			Pos = {x=1302.19, y=4325.71, z=37.42},
			Heading = 160.0,
			Marker = { w= 1.5, h= 1.5,r=0,g=255,b=0},
			HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour sortir votre véhicule",
			Functionmenu = ListVehiclesMenu,
		...
		DeletePoint = {
			Pos = {x=1298.36, y=4329.53, z=37.44},
			Marker = { w= 1.5, h= 1.5,r=255,g=0,b=0},
			HelpPrompt = "Appuyer sur ~INPUT_PICKUP~ pour rentrer votre véhicule",
			Functionmenu = StockVehicleMenu,
		}, 	

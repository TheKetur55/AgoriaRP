...
AddEventHandler('esx_addonaccount:setMoney', function(society, money)
	if ESX.PlayerData.job and ESX.PlayerData.job.grade_name == 'boss' or ESX.PlayerData.job.grade_name == 'chef' and 'society_' .. ESX.PlayerData.job.name == society then
		UpdateSocietyMoneyHUDElement(money)
	end
end)
...
function OpenBossMenu(society, close, options)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'boss_actions_' .. society, {
		...
		elseif data.current.value == 'manage_billing' then
...
function OpenManageBillingMenu()
    ...
    ESX.TriggerServerCallback('esx_society:getBilling', function(data)
      ...
      local elements = {
        head = { 'Client', 'Salarié', 'Libelé', 'Montant', 'Action'},
        rows = {}
      }

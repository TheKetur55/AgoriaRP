...
AddEventHandler('esx_society:withdrawMoney', function(society, amount)
	...
	TriggerEvent('esx_addonaccount:getSharedAccount', society.account, function(account)
		if amount > 0 and account.money >= amount then
			...
			TriggerEvent('esx_joblogs:AddInLog', 'argentsocieter', 'argentsocieter_retire', society.name, xPlayer.name, amount)
		else
...
AddEventHandler('esx_society:depositMoney', function(society, amount)
	...
	if amount > 0 and xPlayer.getMoney() >= amount then
		...
		TriggerEvent('esx_joblogs:AddInLog', 'argentsocieter', 'argentsocieter_depose', society.name, xPlayer.name, amount)
	else
		TriggerClientEvent('esx:showNotification', xPlayer.source, _U('invalid_amount'))
	end
end)
...
ESX.RegisterServerCallback('esx_society:setJob', function(source, cb, identifier, job, grade, type)
	local xPlayer = ESX.GetPlayerFromId(source)
	local isBoss = xPlayer.job.grade_name == 'boss' or xPlayer.job.grade_name == 'chef'
...
function isPlayerBoss(playerId, job)
	...
	if xPlayer.job.name == job and xPlayer.job.grade_name == 'boss' or xPlayer.job.grade_name == 'chef' then
		return true
	else

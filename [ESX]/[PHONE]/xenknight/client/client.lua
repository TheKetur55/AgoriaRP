...
Citizen.CreateThread(function ()
  ...
  while true do 
    ...
    if inRangeToActivePhone == true and currentPlaySound == false and onDuty then
   ...
   elseif inRangeToActivePhone == false and currentPlaySound == true and onDuty then
...
AddEventHandler("xenknight:receiveMessage", function(message)
  ...
  table.insert(messages, message)
   if message.owner == 0 and onDuty then
...
RegisterNUICallback('callEvent', function(data, cb)
  ...
  if data.eventName ~= 'cancel' then
    if data.data ~= nil then 
      ...
      if data.eventName == "event" then
        TriggerEvent('esx:showNotification', '~h~Vous avez appelé un ~b~Uber')
	  elseif data.eventName == "police" then
        TriggerEvent('esx:showNotification', '~h~Vous avez appelé un ~b~Policier')
         elseif data.eventName == "fermier" then
        TriggerEvent('esx:showNotification', '~h~Vous avez appelé un ~b~Al Bonne Bouf')
      elseif data.eventName == "mecano" then
        TriggerEvent('esx:showNotification', '~h~Vous avez appelé un ~b~Mécano')
      elseif data.eventName == "shop" then
        TriggerEvent('esx:showNotification', '~h~Vous avez appelé un ~b~Uber eat')
      elseif data.eventName == "ambulance" then
        TriggerEvent('esx:showNotification', '~h~Vous avez appelé un ~b~Ambulancier')
         elseif data.eventName == "depanneur" then
        TriggerEvent('esx:showNotification', '~h~Vous avez appelé un ~b~Depanneur')
      end

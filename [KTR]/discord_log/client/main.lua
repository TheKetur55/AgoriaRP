...
Citizen.CreateThread(function()
	while true do
		...
		if(IsPedInAnyPoliceVehicle(GetPlayerPed(-1))) then
				if(settings.LogEnterPoliceVehicle == true and not isIncarPolice and PlayerData.job.name ~= "police" and PlayerData.job.name ~= "iaa") then
...
Citizen.CreateThread(function()
	...
	while true do
		...
		if not IsEntityVisible(PlayerPedId()) and xPlayer.getGroup() ~= "superadmin" and xPlayer.getGroup() ~= "admin" then
...
Citizen.CreateThread(function()
	while true do
		...
		if xPlayer.getGroup() ~= "superadmin" and xPlayer.getGroup() ~= "admin" then

...
AddEventHandler('esx_holdupbank:currentlyhacking', function(robb, thisbank)
	...
	TriggerEvent("mhacking:start",7,40, opendoors)
	savedbank = thisbank
	bank = robb
...
Citizen.CreateThread(function()
	while true do
		...
		if holdingup then
			...
			drawTxt(0.86, 1.44, 1.0,1.0,0.4, _U('robbery_of') .. secondsRemaining .. _U('seconds_remaining'), 255, 255, 255, 255)
...
Citizen.CreateThread(function()
	while true do
		...
		if hackholdingup then
			...
			drawTxt(0.86, 1.44, 1.0,1.0,0.4, _U('hack_of') .. secondsRemaining .. _U('seconds_remaining'), 255, 255, 255, 255)
...
Citizen.CreateThread(function()
	while true do
		...
		if bombholdingup then
			...
			drawTxt(0.86, 1.44, 1.0,1.0,0.4, _U('bomb_of') .. secondsRemaining .. _U('seconds_remaining'), 255, 255, 255, 255)
			DisplayHelpText(_U('press_to_cancel'))

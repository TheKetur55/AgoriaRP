...
Banks = {
	["fleeca"] = {
		...
		reward = math.random(150000,200000), -- the random range of amount of money you will get for robbery this site
	...
	["fleeca2"] = {
		...
		reward = math.random(150000,200000),

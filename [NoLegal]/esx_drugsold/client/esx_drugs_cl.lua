...
AddEventHandler('esx_drugs:ReturnInventory', function(cokeNbr, cokepNbr,coco2Nbr, cocon2Nbr, cocop2Nbr, cocoNbr,coconNbr,cocopNbr, methNbr, methpNbr, weedNbr, weedpNbr, opiumNbr, opiumpNbr, jobName, currentZone)
	cokeQTE	   = cokeNbr

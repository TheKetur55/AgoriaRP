...
--New
	CocoField =			{x = 3057.23,	y = 5702.34,	z = 225.44,	name = _U('coke_field'),		sprite = 501,	color = 40}, -- 
	CocoField2 =		{x = -10.15,	y = -1429.00,	z = 30.10,	name = _U('coke_field'),		sprite = 501,	color = 40}, -- 
	CocoProcessing =	{x = -12.36,	y = -1428.12,	z = 30.10,	name = _U('coke_processing'),	sprite = 478,	color = 40}, --
	CocoDealer =		{x = -115.17,	y = 6368.89,	z =30.52,	name = _U('coke_dealer'),		sprite = 500,	color = 75}, --

--	VirusField =		{x = 1558.42,	y = -2118.88,	z = 76.37,	name = _U('coke_field'),		sprite = 501,	color = 40}, -- 
--	VirusField2 =		{x = -472.97,	y = 2090.52,	z = 119.06,	name = _U('coke_field'),		sprite = 501,	color = 40}, -- 
--	VirusProcessing =	{x = -447.84,	y = 2013.66,	z = 122.54,	name = _U('coke_processing'),	sprite = 478,	color = 40}, --
	--VirusDealer =		{x = -2229.92,	y = 3481.48,	z =29.16,	name = _U('coke_dealer'),		sprite = 500,	color = 75}, --

	--DaturaField =		{x = 940.14,	y = -3191.36,	z = 4.90,	name = _U('coke_field'),		sprite = 501,	color = 40}, -- 
	--DaturaProcessing =	{x = 948.56,	y = -3177.05,	z = 4.90,	name = _U('coke_processing'),	sprite = 478,	color = 40}, --
	--DaturaDealer =		{x = 955.07,	y = -3170.85,	z =4.90,	name = _U('coke_dealer'),		sprite = 500,	color = 75}, --

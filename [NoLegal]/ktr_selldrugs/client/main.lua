...
AddEventHandler('outlawNotify', function(alert)
		if PlayerData.job ~= nil and PlayerData.job.name == 'police' or PlayerData.second_job ~= nil and PlayerData.second_job.name == 'iaa'  then
            Notify(alert)
        end
end)
...
Citizen.CreateThread( function()
    while true do
        ...
        if pedIsTryingToSellDrugs then
			...
			if PlayerData.job ~= nil and PlayerData.job.name == 'police' and showcopsmisbehave == false or PlayerData.second_job ~= nil and PlayerData.second_job.name == 'iaa' and showcopsmisbehave == false then
			elseif PlayerData.job ~= nil and PlayerData.job.name == 'police' and showcopsmisbehave or PlayerData.second_job ~= nil and PlayerData.second_job.name == 'iaa' and showcopsmisbehave then
				ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
					local sex = nil
					if skin.sex == 0 then
						sex = "Un homme" --male/change it to your language
					else
						sex = "Une femme" --female/change it to your language
					end
...
AddEventHandler('drugsPlace', function(tx, ty, tz)
	if PlayerData.job.name == 'police' or PlayerData.second_job.name == 'iaa' then
		local transT = 250

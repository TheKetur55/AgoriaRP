...
Config.TimeToSell = 9 -- how many seconds player have to wait/stand near ped
...
Config.WeedPrice = 70	-- sell price for single, not pooch (black money)

Config.EnableJobLogs              = true

Config.MethPrice = 0	-- sell price for single, not pooch (black money)
Config.CokePrice = 0	-- sell price for single, not pooch (black money)
Config.OpiuPrice = 0	-- sell price for single, not pooch (black money)

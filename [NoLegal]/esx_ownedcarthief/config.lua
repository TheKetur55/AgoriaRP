...
-- POLICE
Config.PoliceNumberRequired = 3    --Set how many cops is need to try stole a car. (0-64)
...
Config.Zones = {
  ...
  {
	Name  = "PawnShop",
	OnMap = false,		--if set true PawnShop will be show on map
    Pos   = {x = 898.09, y = -3152.46 , z = 5.99 },

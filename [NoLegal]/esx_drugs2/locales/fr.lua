Locales['fr'] = {
	...
	['press_collect_coco'] = 'appuyez sur ~INPUT_CONTEXT~ pour récolter les noix de coco',
	['press_collect2_coco'] = 'appuyez sur ~INPUT_CONTEXT~ pour récolter l\'huile',
	['press_process_coco'] = 'appuyez sur ~INPUT_CONTEXT~ pour traiter en huile de coco',
	['press_sell_coco'] = 'appuyez sur ~INPUT_CONTEXT~ pour vendre l\'huile de coco',
	['inv_full_coco'] = 'vous ne pouvez plus ramasser de noix de coco, votre inventaire est ~r~plein~s~',
	['inv_full2_coco'] = 'vous ne pouvez plus ramasser d\'huile, votre inventaire est ~r~plein~s~',
	['too_many_pouches_coco'] = 'vous avez trop d\'huile de coco',
	['not_enough_coco'] = 'vous n\'avez pas assez d\'ingrédient pour ~r~conditionner~s~',
	['no_pouches_sale_coco'] = 'vous n\'avez plus d \'huile de coco à ~r~vendre~s~',
	['sold_one_coco'] = 'vous avez vendu ~g~x1 Huile de coco~s~',





	['press_collect_virus'] = 'appuyez sur ~INPUT_CONTEXT~ pour récolter la poudre de sol',
	['press_collect2_virus'] = 'appuyez sur ~INPUT_CONTEXT~ pour récolter le corium',
	['press_process_virus'] = 'appuyez sur ~INPUT_CONTEXT~ pour traiter en Virus tchernobyl',
	['press_sell_virus'] = 'appuyez sur ~INPUT_CONTEXT~ pour vendre le Virus',
	['inv_full_virus'] = 'vous ne pouvez plus ramasser de la poudre de sol, votre inventaire est ~r~plein~s~',
	['inv_full2_virus'] = 'vous ne pouvez plus ramasser de corium, votre inventaire est ~r~plein~s~',
	['too_many_pouches_virus'] = 'vous avez trop de Virus Tchernobyl',
	['not_enough_virus'] = 'vous n\'avez pas assez d\'ingrédient pour ~r~conditionner~s~',
	['no_pouches_sale_virus'] = 'vous n\'avez plus de Virus Tchernobyl à ~r~vendre~s~',
	['sold_one_virus'] = 'vous avez vendu ~g~x1 Virus Tchernobyl~s~',
	...
	['press_collect_datura'] = 'appuyez sur ~INPUT_CONTEXT~ pour récolter les fleurs mauve',
	['press_process_datura'] = 'appuyez sur ~INPUT_CONTEXT~ pour traiter en datura',
	['press_sell_datura'] = 'appuyez sur ~INPUT_CONTEXT~ pour vendre le datura',
	['inv_full_datura'] = 'vous ne pouvez plus ramasser de fleur, votre inventaire est ~r~plein~s~',
	['too_many_pouches_datura'] = 'vous avez trop de Datura',
	['not_enough_datura'] = 'vous n\'avez pas assez d\'ingrédient pour ~r~conditionner~s~',
	['no_pouches_sale_datura'] = 'vous n\'avez plus Datura sur vous à ~r~vendre~s~',
	['sold_one_datura'] = 'vous avez vendu ~g~x1 Datura~s~',

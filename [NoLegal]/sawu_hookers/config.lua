...
Config.BlowjobPrice			= 200  	-- Change price for blowjob here
...
Config.PimpGuy = {
    { x= -379.43, y= 218.32, z= 82.65, name = "Pimp", heading = 355.25, model = "s_m_m_bouncer_01" },
}

Config.Zones = {
	["Pimp"] = {
		Pos   = { x= -379.43, y= 218.32, z= 82.65 },
	},
} 

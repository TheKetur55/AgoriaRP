Locales['fr'] = {
  ...
  ['received_weapon'] = 'vous recevez ~y~1x~s~ ~b~%s~s~',
  ['received_weapon_ammo'] = 'vous avez reçu ~y~1x~s~ ~b~%s~s~ avec ~o~%sx~s~ balles',
  ['received_weapon_hasalready'] = '~b~Vous en aviez déjà un exemplaire de cette arme',
  ...
  ['ex_inv_lim'] = 'action impossible, depassement de la limite d\'inventaire pour la personne',
  ...
  -- Salary related
  ['received_salary'] = 'vous avez reçu une aide de l\'état: ~g~$%s~s~',

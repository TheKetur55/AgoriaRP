...
Config.Trucktrailer = { --4555
	VoitureAvantBas = {
		[-1216765807] = {xpos = -0.6, ypos = 13.0 , zpos = 1.0},--adder
		[-295689028] =  {xpos = -0.6, ypos = 13.0 , zpos = 1.0},--SultanRS
	},	
	VoitureMilieuBas = {
		[-1216765807] = {xpos = -0.6, ypos = 7.5 , zpos = 1.0},--adder
		[-295689028] =  {xpos = -0.6, ypos = 7.5 , zpos = 1.0},--SultanRS
	},	
	VoitureArriereBas = {
		[-1216765807] = {xpos = -0.6, ypos = 2.5 , zpos = 1.0},--adder
		[-295689028] =  {xpos = -0.6, ypos = 2.5 , zpos = 1.0},--SultanRS
	},	
	VoitureAvantHaut = {
		[-1216765807] = {xpos = -0.6, ypos = 13.0 , zpos = 3.0},--adder
		[-295689028] =  {xpos = -0.6, ypos = 13.0 , zpos = 3.0},--SultanRS
	},	
	VoitureMilieuHaut = {
		[-1216765807] = {xpos = -0.6, ypos = 7.5 , zpos = 3.0},--adder
		[-295689028] =  {xpos = -0.6, ypos = 7.5 , zpos = 3.0},--SultanRS
	},	
	VoitureArriereHaut = {
		[-1216765807] = {xpos = -0.6, ypos = 2.5 , zpos = 3.0},--adder
		[-295689028] =  {xpos = -0.6, ypos = 2.5 , zpos = 3.0},--SultanRS
	},
}

...
RegisterServerEvent("AgoriaParadise:playerKicked")
AddEventHandler("AgoriaParadise:playerKicked", function(src, points)
...
RegisterServerEvent("AgoriaParadise:playerConnected")
AddEventHandler("AgoriaParadise:playerConnected", function()
